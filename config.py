...
if MAX_VIDEO_SIZE_MB < 100:
    MAX_VIDEO_SIZE_MB = 100
MAX_VIDEO_SIZE_BYTES = MAX_VIDEO_SIZE_MB * 1024 * 1024

TRANSCODE_TARGET_SIZE_MB = int(os.getenv("TRANSCODE_TARGET_SIZE_MB", 500))
if TRANSCODE_TARGET_SIZE_MB < 100:
    TRANSCODE_TARGET_SIZE_MB = 100
